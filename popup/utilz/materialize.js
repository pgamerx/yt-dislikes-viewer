                ...
                if ("scroll" === C) {
                  ...
                  h.container
                    ? p.isWrapped(h.container) || p.isNode(h.container)
                      ...
                      : (h.container = null)
                    : ((u =
                        t.State.scrollAnchor[t.State["scrollProperty" + A]]),
                      (w =
                        t.State.scrollAnchor[
                          t.State[
                  ...
                  g(f).tweensContainer &&
                    ...
                    m.each(q, function (b, c) {
                      if (
                        RegExp("^" + v.Lists.colors.join("$|^") + "$").test(b)
                      ) {
                        var e = a(c, !0),
                          f = e[0],
                          g = e[1],
          ...
          function e(b) {
            ...
            if (
              ...
              k + j.innerWidth() > a(window).width()
                ? (m = "right")
                : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"),
              l + j.innerHeight() > e)
            )
            ...
            j.css({
              ...
              j
                ...
                .animate(
                  { opacity: 1 },
                  { queue: !1, duration: h.inDuration, easing: "easeOutSine" }
                );
          }
          function f() {
            (i = !1),
                ...
                i ||
                  ...
                  0 !== a(b.target).closest(".dropdown-content").length
                    ? g.hasClass("active") &&
                      (f(),
                      a(document).unbind(
                        "click." + j.attr("id") + " touchstart." + j.attr("id")
                      ))
    ...
    var b = {
      init: function () {
        return this.each(function () {
          ...
          if (
            (b.is(":visible") &&
              (j.css({ right: f - (i + 1) * g }), j.css({ left: i * g })),
            a(window).resize(function () {
              (f = b.width()),
                (g = b.find("li").first().outerWidth()),
                0 > i && (i = 0),
            ...
            document.body.removeChild(k),
              0 === l && ((l = 15), b.find(".indicator").css("bottom", l)),
      ...
      return "remove" === c
        ...
        : ((c = a.extend(h, c)),
          this.each(function () {
            ...
            l.appendTo(k),
              l.css({ top: 0, left: 0 }),
              i.off("mouseenter.tooltip mouseleave.tooltip"),
              i.on({
                "mouseenter.tooltip": function () {
                  var a = i.data("delay");
                  (a = void 0 === a || "" === a ? c.delay : a),
                    (d = 0),
                    (f = setInterval(function () {
                      if (((d += 10), d >= a && e === !1)) {
                        ...
                        "top" === n
                          ...
                          : ((c = i.offset().top + i.outerHeight() + g),
                            (f = i.offset().left + j / 2 - p / 2),
                            (h = b(f, c, p, o)),
                            (q = "+10px"),
                            l.css({ marginLeft: p / 2 - l.width() / 2 })),
                          k.css({ top: h.y, left: h.x }),
                          (s = p / 8),
                          8 > s && (s = 8),
                          ("right" === n || "left" === n) &&
                            ((s = p / 10), 6 > s && (s = 6)),
                ...
                "mouseleave.tooltip": function () {
                  clearInterval(f),
                    ...
                    k.velocity(
                      ...
                      { duration: 225, queue: !1, delay: 225 }
                    ),
                    l.velocity(
                      { opacity: 0, scale: 1 },
                      {
              ...
              e.hasClass("fixed") &&
                a(window).resize(function () {
                  window.innerWidth > 992
                    ...
                    : h === !1 &&
                      ("left" === b.edge
                        ? e.css("left", -1 * (b.menuWidth + 10))
                        : e.css("right", -1 * (b.menuWidth + 10)));
                }),
              b.closeOnClick === !0 &&
                e.on(
                  "click.itemclick",
        ...
        b.on("scrollSpy:enter", function () {
          ...
          h[0]
            ? (a("a[href=#" + h[0].attr("id") + "]").removeClass("active"),
              b.data("scrollSpy:id") < h[0].data("scrollSpy:id")
                ? h.unshift(a(this))
                : h.push(a(this)))
            : h.push(a(this)),
    ...
    a(document).ready(function () {
      function b(b) {
        ...
        e && d.css("font-size", e),
          ...
          "off" === b.attr("wrap") &&
            d.css("overflow-wrap", "normal").css("white-space", "pre"),
          d.text(b.val() + "\n");
        var f = d.html().replace(/\n/g, "<br>");
        d.html(f),
          b.is(":visible")
            ? d.css("width", b.width())
            : d.css("width", a(window).width() / 2),
      ...
      d.length ||
        ((d = a('<div class="hiddendiv common"></div>')), a("body").append(d));
        ...
        function c(a, b, c) {
          ...
          -1 === e ? a.push(b) : a.splice(e, 1),
            c
              ...
              .eq(b)
              .toggleClass("active"),
            c.find("option").eq(b).prop("selected", !0),
            d(a, c);
        }
        function d(a, b) {
        ...
        a(this).each(function () {
          ...
          if (!d.hasClass("browser-default")) {
            ...
            var i = a(
              ...
              m = !1;
            label =
              d.find("option:selected").length > 0
                ...
                a(
                  "multiple" === d
                    ? '<li class="' +
                        ...
                        c.html() +
                        "</span></li>"
                    : '<li class="' + e + '"><span>' + c.html() + "</span></li>"
                )
              );
            };
            k.length
          ...
          this.each(function () {
            ...
            -1 != k && (e = j.eq(k)),
              h.hasClass("fullscreen") ||
                (h.height(b.indicators ? b.height + 40 : b.height),
                i.height(b.height)),
          ...
          a(b)
            ...
            .each(function () {
              a(this).velocity(
                ...
                { duration: 800, delay: c, easing: [60, 10] }
              ),
                (c += 120);
            });
      }),
            ...
            "mousedown click": function (b) {
              ...
              c != y.$root.children()[0] &&
                ...
                "mousedown" != b.type ||
                  ...
                  (b.preventDefault(), y.$root[0].focus()));
            },
          })
          .on({
            focus: function () {
